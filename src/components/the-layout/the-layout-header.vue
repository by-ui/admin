<template>
    <div class="app-header">
        ...
        <by-menu mode="horizontal"
            ...
            <by-menu-item name="3"><i class="icon icon-life-buoy"></i>导航菜单三</by-menu-item>
        ...
        <div class="header-end">
            <ul class="ul-list">
                ...
                <li class="menu-list user">
                    <by-dropdown>
                        <i class="icon icon-github user-icon"></i>
